...
| 🧑‍💼 **[docs/USER_GUIDE.md](docs/USER_GUIDE.md)** | Руководство пользователя: интерфейс, системы, конфигурации и операции backup |
...
| Сервер | Назначение |
| :--- | :--- |
| **dev.backuphub.spb.ru** | Тестовый стенд (Staging) |
| **prod.backuphub.spb.ru** | Продакшн-контур | 
| **infra.backuphub.spb.ru** | Мониторинг, логи, MinIO, Vault |
| **secops.backuphub.spb.ru** | CI/CD, реестр, SecOps |
