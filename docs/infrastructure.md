...
| :--- | :--- | :--- | :--- | :--- |
| **Полное имя хоста** | `dev.backuphub.spb.ru` | `prod.backuphub.spb.ru` | `infra.backuphub.spb.ru` | `secops.backuphub.spb.ru` |
| **IP-адрес** | `130.49.129.180/24` | `153.80.184.132/24` | `78.17.144.232/24` | `157.22.230.253/24` |
| **ОС** | Ubuntu 22.04.5 LTS | Ubuntu 22.04.2 LTS | Ubuntu 24.04 LTS | *Не указано* |
| **SSH порт** | `8228` | `8228` | `8228` | *Не указано* |
| **RAM** | 1 GB | 1 GB | 2 GB | *Не указано* |
| **Диск** | 15 GB ext4 | 15 GB ext4 | 15 GB ext4 | *Не указано* |
