...
class TestBackupAPI:
    ...
    def test_list_backups_unauthenticated(self, api_client):
        """Test: Unauthenticated user can see backups (AllowAny)"""
        BackupFactory.create_batch(5)
        url = reverse('backup-list')
        response = api_client.get(url)

        assert response.status_code == status.HTTP_200_OK
        assert len(response.data) == 5  # Without pagination

    def test_list_backups_empty(self, api_client):
    ...
    def test_retrieve_backup(self, api_client):
    ...
    def test_retrieve_nonexistent_backup(self, api_client):
    ...
    def test_create_backup_success(self, api_client):
    ...
    def test_create_backup_with_target_system(self, api_client):
    ...
    def test_create_backup_auto_system_from_host(self, api_client):
    ...
    def test_create_backup_invalid_host(self, api_client):
    ...
    def test_create_backup_invalid_target_system(self, api_client):
    ...
    def test_create_backup_missing_host_id(self, api_client):
    ...
    def test_update_backup_success(self, api_client):
    ...
    def test_update_backup_partial(self, api_client):
    ...
    def test_update_backup_final_status_with_end_time(self, api_client):
    ...
    def test_update_backup_does_not_override_end_time(self, api_client):
    ...
    def test_update_backup_invalid_data(self, api_client):
    ...
    def test_update_nonexistent_backup(self, api_client):
    ...
    def test_backup_serialization_format(self, api_client):
    ...
    def test_backup_filtering_not_implemented(self, api_client):
